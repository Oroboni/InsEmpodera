    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
           ...
           modelBuilder.Entity<Comunidade>().HasData(
                new Comunidade { IdComunidade = 1, Nome = "Comunidade Esperança", Local = "Bairro A", Status = "Em Processo", Complemento = "", Descricao = "Comunidade piloto", DescricaoAcessibilidade = "Rampa", DtCriacao = new DateTime(2023, 1, 1), DtModificacao = new DateTime(2025, 1, 1), FkIdUsuario = 1 },
                new Comunidade { IdComunidade = 2, Nome = "Comunidade São Miguel", Local = "Bairro B", Status = "Em diagnóstico", Complemento = "Sala 2", Descricao = "Comunidade secundária", DescricaoAcessibilidade = "Elevador", DtCriacao = new DateTime(2023, 2, 1), DtModificacao = new DateTime(2025, 2, 1), FkIdUsuario = 2 },
                new Comunidade { IdComunidade = 3, Nome = "Comunidade Nova Vida", Local = "Bairro C", Status = "Em diagnóstico", Complemento = "", Descricao = "Comunidade remota", DescricaoAcessibilidade = "Rampas", DtCriacao = new DateTime(2023, 3, 1), DtModificacao = new DateTime(2025, 3, 1), FkIdUsuario = 3 },
                new Comunidade { IdComunidade = 4, Nome = "Comunidade Boa Vista", Local = "Bairro D", Status = "Em diagnóstico", Complemento = "Anexo", Descricao = "Comunidade urbana", DescricaoAcessibilidade = "Acesso", DtCriacao = new DateTime(2023, 4, 1), DtModificacao = new DateTime(2025, 4, 1), FkIdUsuario = 4 },
                new Comunidade { IdComunidade = 5, Nome = "Comunidade Vale Verde", Local = "Bairro E", Status = "Em diagnóstico", Complemento = "", Descricao = "Comunidade rural", DescricaoAcessibilidade = "Sem acesso especial", DtCriacao = new DateTime(2023, 5, 1), DtModificacao = new DateTime(2025, 5, 1), FkIdUsuario = 5 }
            );


            // Atores
            modelBuilder.Entity<Atores>().HasData(
                new Atores { IdAtores = 1, Nome = "José Silva", Genero = "Masculino", DtNascimento = new DateTime(1990, 1, 1), PapelSocial1 = "Lider", PapelSocial2 = "Voluntario", Telefone = "11900000001", DtCriacao = new DateTime(2024, 1, 1), DtModificacao = new DateTime(2025, 1, 1), Ativo = "S", FkIdUsuario = 1 },
                new Atores { IdAtores = 2, Nome = "Maria Santos", Genero = "Feminino", DtNascimento = new DateTime(1992, 2, 2), PapelSocial1 = "Beneficiario", PapelSocial2 = "Membro", Telefone = "11900000002", DtCriacao = new DateTime(2024, 2, 1), DtModificacao = new DateTime(2025, 2, 1), Ativo = "S", FkIdUsuario = 1 },
                new Atores { IdAtores = 3, Nome = "Antonio Pereira", Genero = "Masculino", DtNascimento = new DateTime(1985, 3, 3), PapelSocial1 = "Parceiro", PapelSocial2 = "Voluntario", Telefone = "11900000003", DtCriacao = new DateTime(2024, 3, 1), DtModificacao = new DateTime(2025, 3, 1), Ativo = "S", FkIdUsuario = 1 },

                new Atores { IdAtores = 4, Nome = "Francisca Aparecida", Genero = "Feminino", DtNascimento = new DateTime(1991, 4, 4), PapelSocial1 = "Lider", PapelSocial2 = "Coordenador", Telefone = "11900000004", DtCriacao = new DateTime(2024, 4, 1), DtModificacao = new DateTime(2025, 4, 1), Ativo = "S", FkIdUsuario = 1 },
                new Atores { IdAtores = 5, Nome = "Joao Veloso", Genero = "Masculino", DtNascimento = new DateTime(1988, 5, 5), PapelSocial1 = "Beneficiario", PapelSocial2 = "Voluntario", Telefone = "11900000005", DtCriacao = new DateTime(2024, 5, 1), DtModificacao = new DateTime(2025, 5, 1), Ativo = "S", FkIdUsuario = 1 },
                new Atores { IdAtores = 6, Nome = "Ana Ferreira", Genero = "Feminino", DtNascimento = new DateTime(1993, 6, 6), PapelSocial1 = "Parceiro", PapelSocial2 = "Membro", Telefone = "11900000006", DtCriacao = new DateTime(2024, 6, 1), DtModificacao = new DateTime(2025, 6, 1), Ativo = "S", FkIdUsuario = 1 },

                new Atores { IdAtores = 7, Nome = "Carlos Rocha", Genero = "Masculino", DtNascimento = new DateTime(1994, 7, 7), PapelSocial1 = "Lider", PapelSocial2 = "Voluntario", Telefone = "11900000007", DtCriacao = new DateTime(2024, 7, 1), DtModificacao = new DateTime(2025, 7, 1), Ativo = "S", FkIdUsuario = 1 },
                new Atores { IdAtores = 8, Nome = "Paula Mendes", Genero = "Feminino", DtNascimento = new DateTime(1995, 8, 8), PapelSocial1 = "Beneficiario", PapelSocial2 = "Membro", Telefone = "11900000008", DtCriacao = new DateTime(2024, 8, 1), DtModificacao = new DateTime(2025, 8, 1), Ativo = "S", FkIdUsuario = 1 },
                new Atores { IdAtores = 9, Nome = "Rafael Teixeira", Genero = "Masculino", DtNascimento = new DateTime(1996, 9, 9), PapelSocial1 = "Parceiro", PapelSocial2 = "Voluntario", Telefone = "11900000009", DtCriacao = new DateTime(2024, 9, 1), DtModificacao = new DateTime(2025, 9, 1), Ativo = "S", FkIdUsuario = 1 },

                new Atores { IdAtores = 10, Nome = "Luciana Alves", Genero = "Feminino", DtNascimento = new DateTime(1987, 10, 10), PapelSocial1 = "Lider", PapelSocial2 = "Coordenador", Telefone = "11900000010", DtCriacao = new DateTime(2024, 10, 1), DtModificacao = new DateTime(2025, 10, 1), Ativo = "S", FkIdUsuario = 1 },
                new Atores { IdAtores = 11, Nome = "Marcos Ribeiro", Genero = "Masculino", DtNascimento = new DateTime(1986, 11, 11), PapelSocial1 = "Beneficiario", PapelSocial2 = "Membro", Telefone = "11900000011", DtCriacao = new DateTime(2024, 11, 1), DtModificacao = new DateTime(2025, 11, 1), Ativo = "S", FkIdUsuario = 1 },
                new Atores { IdAtores = 12, Nome = "Juliana Freire", Genero = "Feminino", DtNascimento = new DateTime(1989, 12, 12), PapelSocial1 = "Parceiro", PapelSocial2 = "Voluntario", Telefone = "11900000012", DtCriacao = new DateTime(2024, 12, 1), DtModificacao = new DateTime(2025, 12, 1), Ativo = "S", FkIdUsuario = 1 },

                new Atores { IdAtores = 13, Nome = "Bruno Araujo", Genero = "Masculino", DtNascimento = new DateTime(1997, 1, 13), PapelSocial1 = "Membro", PapelSocial2 = "", Telefone = "11900000013", DtCriacao = new DateTime(2025, 1, 1), DtModificacao = new DateTime(2025, 1, 1), Ativo = "S", FkIdUsuario = 1 },
                new Atores { IdAtores = 14, Nome = "Camila Pacheco", Genero = "Feminino", DtNascimento = new DateTime(1998, 2, 14), PapelSocial1 = "Membro", PapelSocial2 = "", Telefone = "11900000014", DtCriacao = new DateTime(2025, 2, 1), DtModificacao = new DateTime(2025, 2, 1), Ativo = "S", FkIdUsuario = 1 },
                new Atores { IdAtores = 15, Nome = "Diego Fonseca", Genero = "Masculino", DtNascimento = new DateTime(1979, 3, 15), PapelSocial1 = "Membro", PapelSocial2 = "", Telefone = "11900000015", DtCriacao = new DateTime(2025, 3, 1), DtModificacao = new DateTime(2025, 3, 1), Ativo = "S", FkIdUsuario = 1 }
            );
            ...
            modelBuilder.Entity<FichaPrimeiroContato>().HasData(
                new FichaPrimeiroContato { IdFicha = 1, FKidAtores = 1, FkIdComunidade = 1, Status = "EmProgresso", Endereco = "Rua das Flores, 123", Complemento = "Apto 101", Emprego = "Auxiliar Administrativo", CEstabeleceu = "Sim", NovoParceiro = "Não", FornecidoParceiro = "Não", LContato = "Presencial", FonteDados = "Cadastro local", EstaFamiliar = "Casado", EstruFamiliar = "Família nuclear", NFIlhos = 2, NFilhas = 1, AEscolar = 12, SLer = "Sim", SCalc = "Sim", SComp = "Sim", QReabili = 0, LTrat = "Nenhum", Coment = "Pessoa comunicativa, busca oportunidade.", DtContato = new DateTime(2025, 1, 10), HoraContato = new TimeSpan(10, 0, 0), DtCriacao = new DateTime(2025, 1, 10), DtModificacao = new DateTime(2025, 1, 10), FkIdUsuario = 1 },
                new FichaPrimeiroContato { IdFicha = 2, FKidAtores = 2, FkIdComunidade = 2, Status = "EmProgresso", Endereco = "Av. Brasil, 457", Complemento = "Casa", Emprego = "Professor", CEstabeleceu = "Não", NovoParceiro = "Sim", FornecidoParceiro = "Sim", LContato = "Telefone", FonteDados = "Registro comunitário", EstaFamiliar = "Solteiro", EstruFamiliar = "Mora sozinho", NFIlhos = 0, NFilhas = 0, AEscolar = 16, SLer = "Sim", SCalc = "Sim", SComp = "Sim", QReabili = 1, LTrat = "Fisioterapia", Coment = "Precisa de acompanhamento psicológico.", DtContato = new DateTime(2025, 1, 5), HoraContato = new TimeSpan(10, 0, 0), DtCriacao = new DateTime(2025, 1, 5), DtModificacao = new DateTime(2025, 1, 5), FkIdUsuario = 1 },
                new FichaPrimeiroContato { IdFicha = 3, FKidAtores = 3, FkIdComunidade = 3, Status = "EmProgresso", Endereco = "Rua São João, 998", Complemento = "Bloco B", Emprego = "Autônomo", CEstabeleceu = "Sim", NovoParceiro = "Não", FornecidoParceiro = "Não", LContato = "WhatsApp", FonteDados = "Auto-relato", EstaFamiliar = "Casado", EstruFamiliar = "Família extensa", NFIlhos = 1, NFilhas = 2, AEscolar = 8, SLer = "Sim", SCalc = "Não", SComp = "Sim", QReabili = 0, LTrat = "Nenhum", Coment = "Demonstra interesse em programas sociais.", DtContato = new DateTime(2025, 1, 3), HoraContato = new TimeSpan(10, 0, 0), DtCriacao = new DateTime(2025, 1, 3), DtModificacao = new DateTime(2025, 1, 3), FkIdUsuario = 2 },
                new FichaPrimeiroContato { IdFicha = 4, FKidAtores = 4, FkIdComunidade = 4, Status = "EmProgresso", Endereco = "Travessa do Sol, 55", Complemento = "", Emprego = "Desempregado", CEstabeleceu = "Não", NovoParceiro = "Não", FornecidoParceiro = "Não", LContato = "Presencial", FonteDados = "Centro comunitário", EstaFamiliar = "Separado", EstruFamiliar = "Família monoparental", NFIlhos = 3, NFilhas = 0, AEscolar = 10, SLer = "Sim", SCalc = "Sim", SComp = "Não", QReabili = 0, LTrat = "Nenhum", Coment = "Procura recolocação no mercado.", DtContato = new DateTime(2025, 1, 2), HoraContato = new TimeSpan(10, 0, 0), DtCriacao = new DateTime(2025, 1, 2), DtModificacao = new DateTime(2025, 1, 2), FkIdUsuario = 3 },
                new FichaPrimeiroContato { IdFicha = 5, FKidAtores = 5, FkIdComunidade = 5, Status = "EmProgresso", Endereco = "Praça Central, 321", Complemento = "Sala 5", Emprego = "Comerciante", CEstabeleceu = "Sim", NovoParceiro = "Não", FornecidoParceiro = "Sim", LContato = "E-mail", FonteDados = "Instituição parceira", EstaFamiliar = "Viúvo", EstruFamiliar = "Família nuclear", NFIlhos = 1, NFilhas = 1, AEscolar = 14, SLer = "Sim", SCalc = "Sim", SComp = "Sim", QReabili = 0, LTrat = "Nenhum", Coment = "Interessado em projetos educacionais.", DtContato = new DateTime(2025, 1, 1), HoraContato = new TimeSpan(10, 0, 0), DtCriacao = new DateTime(2025, 1, 1), DtModificacao = new DateTime(2025, 1, 1), FkIdUsuario = 1 }
            );
